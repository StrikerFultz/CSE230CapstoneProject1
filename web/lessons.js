...
<pre style="max-width: 700px; width: fit-content; min-width: 320px; margin: 16px auto; padding: 14px 18px; text-align: left; white-space: pre-wrap; overflow-x: auto; background: #f3f3f3; border: 1px solid #999; border-radius: 4px; font-family: Consolas, monospace; font-size: 13px;">
...
<p style="text-align:center">The resultant array is:</p>
...
<p style="text-align:center">Given an array (base address and number of elements), write a MIPS program to do the following:</p>
<ul style="width: fit-content; margin: 12px auto; text-align: left; padding-left: 24px;">
...
<p style="text-align:center">The resultant registers are:</p>
...
<p style="text-align:center">The resultant registers will be:</p>
...
<p style="text-align:center">The resultant array P is:</p>
...
<p style="text-align:center">Given Inputs:</p>
<ul style="width: fit-content; margin: 12px auto; text-align: left; padding-left: 24px;">
...
<p style="text-align:center">And each node contains:</p>
<ul style="width: fit-content; margin: 12px auto; text-align: left; padding-left: 24px;">
  <li>an integer value</li>
  <li>address to the next node (address is NULL (0) if it is the last node in the list)</li>
</ul>

<p style="text-align:center">Write the following three functions that will be called in order to update the linked list by adding the new node.</p>
...
<p style="text-align:center">Linked List and New Node in Memory:</p>
...
<p style="text-align:center">Write the following functions in MIPS.</p>
...
<p style="text-align:center">The resultant array B is:</p>
